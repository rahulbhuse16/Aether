...
import { toggleTask, addTask, updateTaskStatus } from "../store/slices/tasksSlice";
    ...
    <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] p-3">
      ...
      <div className="mt-2 flex gap-1">
        {STATUS_COLUMNS.map((col) => (
          <button
            key={col.key}
            onClick={() => dispatch(updateTaskStatus({ id: task.id, status: col.key }))}
    ...
    <AppShell title="Task planner">
      <div className="mx-auto max-w-5xl space-y-8">
        <PageSection
          ...
          description="Tasks from GitHub, Jira, and AI suggestions — all in one planner."
        />
          ...
          {[
            ...
            >
              <GlassCard className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[20px] font-medium text-[#F4F3EF]">{stat.count}</p>
            ...
            return (
              ...
              >
                <h3 className="mb-3 text-[13px] font-medium text-[#94969E]">
                  {col.label}{" "}
                  <span className="text-[#55575F]">({columnTasks.length})</span>
                </h3>
